...
DWORD WINAPI Main(LPVOID)
{
    ...
    std::cout << "     _                    _     _          __  __   ____      " << std::endl;
    std::cout << "    / \     _ __    ___  | |_  (_)   ___  |  \/  | |  _ \    " << std::endl;
    std::cout << "   / _ \   | '__|  / __| | __| | |  / __| | |\/| | | |_) |    " << std::endl;
    std::cout << "  / ___ \  | |    | (__  | |_  | | | (__  | |  | | |  __/     " << std::endl;
    std::cout << " /_/   \_\ |_|     \___|  \__| |_|  \___| | |  | | |_|       " << std::endl;
    std::cout << "                                                          " << std::endl;
    std::cout << "CLI / Legacy Launcher\n";

    std::cout << "Join our Discord! - https://dsc.gg/arctic\n";
    std::cout << "Credits to Milxnor for Cobalt - https://github.com/Milxnor/Cobalt";
